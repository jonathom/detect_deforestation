...
h <- array(imgdata, dim = c(140, 140, 12, 7), dimnames = list(xlab, ylab, doi, years))
h <- aperm(h, c(2,1,3,4))
...
# d <- Gapfill(h, iMax = 5)
# saveRDS(d, "./iMax5_140_gapfilled.rds")
gf <- readRDS("monthly_iMax5_140_gapfilled.rds")
Image(gf$fill)
```
